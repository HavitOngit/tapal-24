<script lang="ts">
	...
	import { History, ReceiptIndianRupee, MessageCircleHeart, Mail, LogOutIcon } from 'lucide-svelte';
			...
			<div class="flex flex-col gap-7">
				...
				<div>
					...
					<div class="mt-2 flex flex-col gap-5">
						{#each lisnks as link}
							<Button variant="link" class="flex  justify-start" on:click={closeDiloag}>
								<a href={link.href}>
